 ...
 void frontscreen(void)
{
    ...
    glColor3f(1,1,1);
	output(35,160,"EAST POINT COLLEGE OF ENGINEERING");
	glColor3f(1,1,1);
	...
	glEnd();
	glColor3f(1,0,0);
	output(40,90,"ADITYA SINHA and KUMAR HARSH MATHURI ");
	...
	output(40,50,"");
	glColor3f(1,0,0);
	drawstring(72,50,"Mr.PRAVEEN PAWASKAR",GLUT_BITMAP_HELVETICA_12);
	glColor3f(1,0,0);
	output(70,40,"Lecturer,Dept. of CSE");
	glColor3f(1,0,0);
	output(40,30,"");
	glColor3f(1,0,0);
	drawstring(72,30,"Mrs.SUPRITHA.R",GLUT_BITMAP_HELVETICA_12);
