...
frnt[3][3]={{2,2,2},{2,2,2},{2,2,2}},
bck[3][3]={{3,3,3},{3,3,3},{3,3,3}},
...
polygon(frnt[1][1],44,45,46,47);
polygon(6,40,41,45,44);
}
void colorcube7()
{
polygon(bck[1][1],48,51,50,49);
...
polygon(frnt[0][1],76,77,78,79);
polygon(6,72,73,77,76);
}
void colorcube11()
{
polygon(bck[0][1],80,83,82,81);
...
polygon(frnt[2][1],84+24,85+24,86+24,87+24);
polygon(bottom[0][1],80+24,81+24,85+24,84+24);
}
void colorcube15()
{
polygon(bck[2][1],112,115,114,113);
...
void colorcube16()
{
polygon(bck[0][2],120,123,122,121);
...
polygon(frnt[0][0],132,133,134,135);
polygon(6,128,129,133,132);
}
void colorcube18()
{
polygon(bck[0][0],136,139,138,137);
...
polygon(frnt[0][2],148,149,150,151);
polygon(6,144,145,149,148);
}
void colorcube20()
{
polygon(bck[1][2],152,155,154,153);
...
polygon(frnt[1][0],164,165,166,167);
polygon(6,160,161,165,164);
}
void colorcube22()
{
polygon(bck[1][0],168,171,170,169);
...
polygon(frnt[1][2],180,181,182,183);
polygon(6,176,177,181,180);
}
void colorcube24()
{
polygon(bck[2][2],184,187,186,185);
...
polygon(frnt[2][0],196,197,198,199);
polygon(bottom[0][0],192,193,197,196);
}
void colorcube26()
{
polygon(bck[2][0],200,203,202,201);
...
polygon(frnt[2][2],212,213,214,215);
